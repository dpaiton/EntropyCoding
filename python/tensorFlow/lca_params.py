...
class parameters(object):
  def __init__(self):
    self.user_params = {\
      "version"              : "1",            # [str] Version for output
      ...
      "checkpoint"           : 50,             # [int] How often to checkpoint
    ...
    self.model_schedule= [ \
      {"weights"     : ["phi", "w"], # [list of str] Which weights to update
      ...
      "lr"          : [0.01, 0.1],    # [list of float] Learning rates for weight updates
      "decay_steps" : [3000,]*2,   # [list of int] How often to decay for SGD annealing
      "decay_rate"  : [0.9,]*2,    # [list of float] Rate to decay for SGD annealing
      "staircase"   : [True,]*2,   # [list of bool] Annealing can be step (T) or exponential (F)
